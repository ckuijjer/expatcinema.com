...
const filterScreeningsWithLLM = async (
  ...
  const prompt = [
    ...
    '',
    'Example subtitle notes that mean all screenings have English subtitles:',
    '- wp-block-vo-info-item with ondertitels and english',
    '- The screening of Amigo Secreto will be with English subtitles on Tuesdays and Saturdays at 20:30.',
    '- This film will be shown with English subtitles every evening at 19:00 (Thursdays on 19:30).',
    '',
    'Example subtitle notes that mean only some screenings have English subtitles:',
    '- This film will be shown with English subtitles on the following dates:',
    '- English subtitles on the following dates:',
    '',
    'Example screening schedule text to use when deciding which screenings match:',
    '- Thursday: 12:30',
    '- Friday & Saturday: 12:45',
    '- Monday & Tuesday & Wednesday: 21:30',
    '',
    'Screenings:',
